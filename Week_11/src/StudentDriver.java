...
public class StudentDriver {
	public static void main(String[] args) {
	    ...
	    System.out.println("Before Sorting by year : " + group);
	    Collections.sort(group, (a, b) -> a.getYear() - b.getYear());
	    System.out.println("After  Sorting by year : " + group);
	    ...
	    Collections.sort(group, (a, b) -> a.getName().length() - b.getName().length());
...
class StudentNameLenComparator implements Comparator<Student> {
    @Override
    public int compare(Student firstStudent, Student secondStudent) {
       return (firstStudent.getName().length() - secondStudent.getName().length());
    }
}