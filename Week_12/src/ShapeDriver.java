...
public class ShapeDriver {
	public static void main(String[] args) throws InterruptedException {
		...
		Collections.sort(arrList, new Comparator<Shape>() {
			@Override
		...
		Collections.sort(arrList, new Comparator<Shape>() {
		    ...
		    public int compare(Shape firstStudent, Shape secondStudent) {
		    	...
		    	return (df.format(firstStudent.getTime()).compareTo(df.format(secondStudent.getTime())));
		    }
		});
		System.out.println("By time:" + arrList);
		
		System.out.println("\n---Using Lambda expreesion---");
		Collections.sort(arrList, (a, b) -> a.getArea() - b.getArea());
		System.out.println("By area:" + arrList);
...
class SortByTime implements Comparator<Shape> {
    @Override
    public int compare(Shape firstStudent, Shape secondStudent) {
    	SimpleDateFormat df = new SimpleDateFormat("mm:ss");
    	return (df.format(firstStudent.getTime()).compareTo(df.format(secondStudent.getTime())));
